...
<body>
  ...
  <section id="wrapper">
    ...
    <div class="p-4">
      <div class="welcome">
        <h1 class="fs-3">Civil Status Records</h1>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-3 ms-3">
        <form action="process.php" method="POST">
          ...
          <input type="text" class="form-control" id="civilStatus" name="civilStatus" placeholder="Single / Married">

          <div class="mt-2 col-12 d-flex flex-row-reverse pe-0">
            <button type="submit" class="btn btn-success ms-auto p-1" name="addCivil"><small>Add Civil
                Status</small></button>
          </div>
        </form>
      ...
      <div class="mx-4 col-8">
        <table id="example" class="table table-striped" style="width:100%">
          ...
          <tbody>
            ...
            <tr>
              <td><?= $row['Civil_Status_ID'] ?></td>
              <td><?= $row['Civil_Status_Name'] ?></td>
              <td><?= $row['Date_Created'] ?></td>
              <td>
                <button type="button" class="btn btn-primary editCivilBtn" data-bs-toggle="modal"
                  data-bs-target="#editModal" data-edit-id="<?= $row['Civil_Status_ID'] ?>">
                  <i class="fa-regular fa-pen-to-square"></i>
                </button>
              </td>
              <td>
                <button type="button" class="btn btn-danger deleteCivilBtn" data-bs-toggle="modal"
                  data-bs-target="#deleteModal" data-delete-id="<?= $row['Civil_Status_ID'] ?>">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 400px; background-color: #eee;">
              ...
              <div class="modal-body">
                <form id="editForm">
                  <label for="civilStatus" class="form-label">Civil Status</label>
                  <input type="hidden" class="form-control" id="updateCivilID" name="updateCivilID">
                  <input type="text" class="form-control" id="civilStatus" name="civilStatus"
                    placeholder="Single / Married">

                  <div class="mt-2 col-12 d-flex flex-row-reverse pe-0">
                    <button type="submit" class="btn btn-success ms-auto p-1" id="updateCivilBtn"
                      name="addCivil"><small>Update Civil
                        Status</small></button>
                  </div>
                </form>
              </div>
  ...
  $(document).ready(function() {
    $('#editPasswordForm').submit(function(event) {
      ...
      var password = $('#editPasswordForm #password').val();
