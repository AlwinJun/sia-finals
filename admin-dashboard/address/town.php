...
$townResult = $conn->query("SELECT * FROM town_table");
?>
    ...
    <div class="row">
      <div class="col-3 ms-3">
        <form action="process.php" method="POST">
          <div class="col-12">
            <select class="form-select mb-3" aria-label="Default select example" id="province" name="province">
            ...
            <label for="town" class="form-label mb-1">Town Name</label>
            <input type="text" class="form-control" id="town" name="town" placeholder="">
          </div>

          <div class="mt-2 col-12 d-flex flex-row-reverse pe-0">
            <button type="submit" class="btn btn-success ms-auto p-1" name="addTown"><small>Add Town</small></button>
          </div>
        </form>
        ...
        <table id="example" class="table table-striped" style="width:100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-primary editTownBtn" data-bs-toggle="modal"
                  data-bs-target="#editModal" data-edit-id="<?= $row['Town_ID'] ?>">
                  <i class="fa-regular fa-pen-to-square"></i>
                </button>
              </td>
              <td>
                <button type="button" class="btn btn-danger deleteTownBtn" data-bs-toggle="modal"
                  data-bs-target="#deleteModal" data-delete-id="<?= $row['Town_ID'] ?>">
        ...
        <div class="modal fade" id="editModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 750px; background-color: #eee;">
              ...
              <div class="modal-body">
                <form id="editForm">
                  <input type="hidden" class="form-control" id="updateTownID" name="updateTownID">
                  <div class="col-12">
                    <select class="form-select mb-3" aria-label="Default select example" id="province" name="province">
                      <option value="">Choose province first</option>
                      <?php foreach($provinceResult as $row): ?>
                  ...
                  <div class="mt-2 col-12 d-flex flex-row-reverse pe-0">
                    <button type="submit" class="btn btn-success ms-auto p-1" name="updateTownBtn"
                      id="updateTownBtn"><small>Update
                        Town</small></button>
                  </div>
                </form>
              </div>
