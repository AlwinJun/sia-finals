...
<body>
  ...
  <section id="wrapper">
    ...
    <div class="p-4">
      <div class="welcome">
        <h1 class="fs-3">Province Records</h1>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-3 ms-3">
        <form action="process.php" method="POST">
          ...
          <div class="mt-2 col-12 d-flex flex-row-reverse pe-0">
            <button type="submit" class="btn btn-success ms-auto p-1" name="addProvince"><small>Add
                Province</small></button>
          </div>
        </form>
        ...
        <table id="example" class="table table-striped" style="width:100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-primary editProvinceBtn" data-bs-toggle="modal"
                  data-bs-target="#editModal" data-edit-id="<?= $row['Province_ID'] ?>">
                  <i class="fa-regular fa-pen-to-square"></i>
                </button>
              </td>
              <td>
                <button type="button" class="btn btn-danger deleteProvinceBtn" data-bs-toggle="modal"
                  data-bs-target="#deleteModal" data-delete-id="<?= $row['Province_ID'] ?>">
        ...
        <div class="modal fade" id="editModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 750px; background-color: #eee;">
              ...
              <div class="modal-body">
                <form id="editForm">
                  <input type="hidden" class="form-control" id="updateProvinceID" name="updateProvinceID">
                  <div class="col-12">
                    <label for="province" class="form-label mb-1">Province Name</label>
                    <input type="text" class="form-control" id="province" name="province" placeholder="">
                  </div>

                  <div class="mt-2 col-12 d-flex flex-row-reverse pe-0">
                    <button type="submit" class="btn btn-success ms-auto p-1" name="updateProvinceBtn"
                      id="updateProvinceBtn"><small>Update
                        Province</small></button>
                  </div>
                </form>
              </div>
