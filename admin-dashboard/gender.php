...
<body>
  ...
  <section id="wrapper">
          ...
          <ul class="navbar-nav ms-auto">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li>
                  <button type="button dropdown-item" class="btn dro" data-bs-toggle="modal"
    ...
    <div class="p-4">
      <div class="welcome">
        <h1 class="fs-3">Gender Records</h1>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-3 ms-3">
        <form action="process.php" method="POST">
          ...
          <div class="mt-2 col-12 d-flex flex-row-reverse pe-0">
            <button type="submit" name="addGender" id="addGender" class="btn btn-success ms-auto p-1">
              <small>Add Gender</small>
            </button>
          </div>
        </form>
        ...
        <table id="example" class="table table-striped" style="width:100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-primary editGenderBtn" data-bs-toggle="modal"
                  data-bs-target="#editModal" data-edit-id="<?= $row['Gender_ID'] ?>">
                  <i class="fa-regular fa-pen-to-square"></i>
                </button>
              </td>
              <td>
                <button type="button" class="btn btn-danger deleteGenderBtn" data-bs-toggle="modal"
                  data-bs-target="#deleteModal" data-delete-id="<?= $row['Gender_ID'] ?>">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 400px; background-color: #eee;">
              ...
              <div class="modal-body">
                <form id="editForm">
                  <label for="gender" class="form-label">Gender</label>
                  <input type="hidden" class="form-control" id="updateGenderID">
                  <input type="text" class="form-control" id="gender" name="gender" placeholder="Male/Female">

                  <div class="mt-2 col-12 d-flex flex-row-reverse pe-0">
                    <button type="submit" name="addGender" id="updateGenderBtn" class="btn btn-success ms-auto p-1">
                      <small>Update Gender</small>
                    </button>
                  </div>
                </form>
              </div>
