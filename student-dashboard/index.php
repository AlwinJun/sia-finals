...
$studentStmt= $conn->prepare("SELECT Firstname,Middlename,Lastname,Extensionname,
                          ...
                          INNER JOIN parent_table ON student_table.Parent_ID = parent_table.Parent_ID WHERE Student_ID = ?");
$studentStmt->bind_param('i', $_SESSION['studentID']);
$studentStmt->execute();
$studentRow = $studentStmt->get_result()->fetch_assoc();

$parentStmt = $conn->prepare("SELECT
                                ParentFirstname, ParentMiddlename,  ParentLastname,ParentExtensionname,
                                Parent_Birthdate,
                                Gender_Name,
                                Parent_Age,
                                Civil_Status_Name,
...
$parentStmt->bind_param('i', $studentRow['Parent_ID']);
$parentStmt->execute();
                    ...
                    <div class="modal-body">
                      <form id="editPasswordForm">
                        ...
                        <input type="hidden" class="form-control" id="updatePasswordID"
                          value="<?= $_SESSION['studentID'] ?>" name="updatePasswordID">
      ...
      <div class="row">
        ...
        <div class="col-2 p-3 bg-success rounded me-3">
          <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#studentModal"
            data-edit-id="<?= $_SESSION['studentID'] ?>">
            <div class="text-white p-1 d-flex flex-row align-items-center justify-content-between">
              ...
              <div class="text-center">
                <span class="text-center">Show My Info</span>
              </div>
            </div>
          </button>
        </div>
                ...
                <form id="viewForm" class="row g-3">
                  ...
                  <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" id="username" name="username"
                      value="<?= $studentRow['Student_Username'] ?>" disabled readonly>
                  </div>
                  <div class="col-md-3">
                    <label for="password" class="form-label">Password</label>
                    <input type="text" class="form-control" id="password" name="password"
                      value="<?= $studentRow['Student_Password'] ?>" disabled readonly>
                  </div>
                </form>
              </div>
            </div>
        ...
        <div class="col-2 p-3 bg-info rounded me-3">
          <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#parentModal"
            data-edit-id="<?= $studentRow['Parent_ID'] ?>">
            <div class="text-white p-1 d-flex flex-row align-items-center justify-content-between">
          ...
          <div class="modal fade" id="parentModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content" style="width: 750px; background-color: #eee;">
                <div class="modal-header">
                  <h5 class="modal-title" id="editModalLabel">My Parent Info</h5>
                  <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
